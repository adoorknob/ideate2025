...
const WhatIsIdeate: React.FC = () => {
    return (
        <div className="bg-inherit flex flex-col items-center text-white justify-center w-full text-base">
            <div className="relative w-full px-10 sm:px-20 h-20 sm:h-28 md:h-40 lg:h-48 xl:h-80">
                <TitleText />
            </div>
            <div className="w-full px-10 sm:px-20 xl:px-30 md:grid md:grid-cols-3 gap-4 gap-y-10">
                <div className="col-span-2 text-sm sm:text-base md:text-xl lg:text-2xl xl:text-4xl text-left">
                ...
                <div className="md:col-span-2 text-sm sm:text-base md:text-xl lg:text-2xl xl:text-4xl text-justify">
