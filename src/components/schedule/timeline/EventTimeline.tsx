...
const EventTimeline = ({ name, activities }: timelineProps) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-x-4 text-2xl md:text-5xl lg:text-7xl lg:pt-16 pt-8 pb-12 min-h-[50vh] gap-y-8 px-4
                ...
                <div className="font-normal w-3/4 z-30">
                    {activities.map(item => (
                        <div key={item.id} className="h-16 grid grid-cols-5 m-5 sm:m-20">
                            <div className="col-span-2 flex flex-col justify-center items-center w-full text-base xs:text-sm md:text-xl lg:text-2xl whitespace-nowrap">
                            ...
                            <p className="col-span-2 text-base xs:text-sm md:text-2xl lg:text-3xl flex items-center">
                                {item.description}
                            </p>
                        </div>
                    ))}
